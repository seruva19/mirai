...
# Vendored for LingBot-Video's native VAE path.
...
class AutoencoderKLWan(nn.Module):
    ...
    This is the plain ``nn.Module`` form used by Mirai's native runtime.
    """
    ...
    def __init__(
        ...
        self.config = SimpleNamespace(
            ...
            decoder_base_dim=(int(decoder_base_dim) if decoder_base_dim is not None else int(base_dim)),
            z_dim=int(z_dim),
