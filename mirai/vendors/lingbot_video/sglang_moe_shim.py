# Adapted for LingBot-Video's SGLang fused-MoE interface (Apache-2.0).
# Source: https://github.com/Robbyant/lingbot-video
# Mirai keeps only the runtime shim used by the native denoiser. See LICENSE.
...
def ensure_sglang_moe_ready() -> None:
    ...
    if sglang_fused_experts is None:
        raise RuntimeError(
            "model.params.moe_expert_backend='sglang_triton' requires SGLang MoE runtime"
